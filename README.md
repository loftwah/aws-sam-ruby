...
This is a sample template for aws-sam-ruby - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-sam-ruby --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-sam-ruby
```
